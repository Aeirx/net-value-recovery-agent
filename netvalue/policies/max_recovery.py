"""Baseline 3 - the success-rate ceiling. Pursues everything recoverable, ignoring cost.

This is an oracle by design and is the sole entry on the boundary allowlist.
